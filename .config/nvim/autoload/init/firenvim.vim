...
augroup init#firenvim
  ...
  autocmd BufEnter {{forum,*-forum,community,devforum,talk,discuss,discourse,gitlab}.*,*.stackexchange.com,aur.archlinux.org,github.com,www.{cnblogs,jianshu}.com}_*.txt set filetype=pandoc
