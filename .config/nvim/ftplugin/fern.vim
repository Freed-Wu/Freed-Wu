...
nnoremap <buffer><expr> za winwidth(0) > &columns/4
      \ ? "\<Plug>(fern-action-zoom:reset)"
      \ : "\<Plug>(fern-action-zoom:half)"
nnoremap <buffer><expr> zA winwidth(0) > &columns/2
      \ ? "\<Plug>(fern-action-zoom:reset)"
...
nmap <buffer> <C-P> <Plug>(fern-action-quickfix:replace)
nmap <buffer> g<C-N> <Plug>(fern-action-loclist)
nmap <buffer> g<C-A> <Plug>(fern-action-loclist:add)
nmap <buffer> g<C-P> <Plug>(fern-action-loclist:replace)
